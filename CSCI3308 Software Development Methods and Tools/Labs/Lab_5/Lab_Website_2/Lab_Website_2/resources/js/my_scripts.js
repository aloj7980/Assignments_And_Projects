...
function loadStatsPage(){
	var table = document.getElementsById("stats_table");
	var wins=0;
	var losses=0;
	for (let i = 0; i < rows.length; i++) { 
		var CUScore = table.rows[i].cells[2].innerHTML;
		var opponentScore = table.rows[i].cells[3].innerHTML;
		if(CUScore>opponentScore){
