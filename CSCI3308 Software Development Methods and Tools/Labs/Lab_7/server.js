...
app.get('/home/pick_color', function(req, res) {
	...
	*/
    .then(function(rows){
    	res.render('pages/home',{
				my_title: "Home Page",
				data: rows,// Return the color options
	...
	app.post('/home/pick_color', function(req, res) {
		...
		const values = [color_hex,color_name,color_message];
		...
		//insert statement doesn't work, so I changes it to a single query for the color options, still displays color from entered hex value
	/*
		db.task('get-everything', task => {
			return task.batch([
		...
		*/
		...
		.then(function(rows) {
			res.render('pages/home',{
					my_title: "Home Page",
					data: rows,// Return the color choices
