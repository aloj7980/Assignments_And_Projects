...
- Many heath outcomes vary based on age
...
![caption](the-world-health-organizations-world-standard-population1_3400.png)

## Age Standardization 

- age standardized rate/average = $\sum_j$ (rate/average within age group $j$) $\times$ (proportion of standardized population $j$)
- note that we could standardize based on characteristics besides or in addition to age


## Regression Estimator

-   We will argue that under the assumptions of consistency and no unmeasured confounding $E\{E(Y|A=1, X) - E(Y|A=0, X)\} = E(Y^1 - Y^0)$
...
Citations: 1) Gerber, Alan S. and Donald P. Green. 2000. "The Effects of Canvassing, Telephone Calls, and Direct Mail on Voter Turnout: A Field Experiment." American Political Science Review 94: 653663. 2) Gerber, Alan S. and Donald P. Green. 2005. "Correction to Gerber and Green (2000), replication of disputed findings, and reply to Imai (2005)." American Political Science Review 99: 301-313. 3) Imai, Kosuke. 2005. "Do Get-Out-The-Vote Calls Reduce Turnout? The Importance of Statistical Methods for Field Experiments." American Political Science Review 99: 283-300.
...
-   Can we use our regression models to conducte a (micro) simulation of this hypothetical trial
